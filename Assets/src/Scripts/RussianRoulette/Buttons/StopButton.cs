...
public class StopButton : MouseInteractable2D
{
    [Header("Hover Effect")]
    [SerializeField]
    ...
    private void Update()
    {
        if (rouletteScript == null || (rouletteScript.GameState != 0 && rouletteScript.GameState != 1 && rouletteScript.GameState != 2))
        {
